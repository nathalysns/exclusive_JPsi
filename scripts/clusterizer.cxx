...
//         cout << "running MA" << endl;
      ...
      if(caloEnum==kEEMC) EEMC_cluster.insert(pair<int, clustersStrct> (nclusters,tempstructC));
      if(caloEnum==kFHCAL) FHCAL_cluster.insert(pair<int, clustersStrct> (nclusters,tempstructC));
      if(caloEnum==kBECAL) BECAL_cluster.insert(pair<int, clustersStrct> (nclusters,tempstructC));
      if(caloEnum==kHCALIN) HCALIN_cluster.insert(pair<int, clustersStrct> (nclusters,tempstructC));
      if(caloEnum==kHCALOUT) HCALOUT_cluster.insert(pair<int, clustersStrct> (nclusters,tempstructC));
      if(caloEnum==kFEMC) FEMC_cluster.insert(pair<int, clustersStrct> (nclusters,tempstructC));
      if(caloEnum==kEHCAL) EHCAL_cluster.insert(pair<int, clustersStrct> (nclusters,tempstructC));
